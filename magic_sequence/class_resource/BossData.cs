...
public partial class BossData : MonsterData
{
	...
	// 발밑 가까이(Near) GroundZoneNearCount개 + 비교적 멀리 나머지로 나눠서 배치한다.
	...
	// === 보스 주사위/사망 사운드. 비어있으면(null) 조용히 재생 스킵 ===
	[ExportGroup("Sfx")]
	[Export] public AudioStream DiceRollSfx { get; set; }
	[Export] public AudioStream DiceLockSfx { get; set; }
	[Export] public AudioStream Dice1ShieldSfx { get; set; }
	[Export] public AudioStream Dice2ShuffleSfx { get; set; }
	[Export] public AudioStream Dice3BarrageSfx { get; set; }
	[Export] public AudioStream Dice4ChainSpawnSfx { get; set; }
	[Export] public AudioStream Dice4ChainReleaseSfx { get; set; }
	[Export] public AudioStream Dice5HealSfx { get; set; }
	[Export] public AudioStream Dice6LaserImpactSfx { get; set; }
	[Export] public AudioStream Dice7BoostSfx { get; set; }
	[Export] public AudioStream BossDeathSfx { get; set; }
	[Export] public AudioStream GroundZoneSfx { get; set; }   // 장판(마법진) 활성화(판정) 순간
}
